...
function Exam() {
  ...
  const totalScheduleStatus = useSelector(
    (state) => state.schedules.totalScheduleStatus
  );
  const totalParticipant = useSelector(
    (state) => state.participants.totalParticipant
  );
              ...
              <TableRow key={i}>
                ...
                <TableCell>
                  <div className="flex items-center space-x-4">
                    <Button
                      onClick={() => {
                        dispatch(updateStatusOnline(user.id));
                      }}
                      layout="link"
                      size="icon"
                      aria-label="Edit"
                    ...
                    <Button
                      onClick={() => {
                        dispatch(updateStatusBanned(user.id));
                      }}
                      layout="link"
                      size="icon"
                      aria-label="Edit"
